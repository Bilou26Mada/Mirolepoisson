    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Génération d'ontologie</span>
          </div>
        ...
        <div class="card-content">
          ...
          <p class="description">
            Analyse LLM du contenu du document et des besoins de simulation, extraction des entités clés et génération automatique de la structure ontologique appropriée.
          </p>

          <!-- Loading / Progress -->
          <div v-if="currentPhase === 0 && ontologyProgress" class="progress-section">
            <div class="spinner-sm"></div>
            <span>{{ ontologyProgress.message || 'Analyse du document en cours...' }}</span>
          </div>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Basé sur l'ontologie générée, le document est segmenté automatiquement puis Zep est appelé pour construire le graphe de connaissances, extraire les entités et relations, et former la mémoire temporelle et les résumés de communauté.
          </p>
          ...
          <div class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">Bords de relations</span>
            </div>
            <div class="stat-card">
              <span class="stat-value">{{ graphStats.types }}</span>
              <span class="stat-label">Types de SCHEMA</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          >
            ...
            {{ creatingSimulation ? 'Création...' : 'Accéder à la configuration de l\'environnement ➝' }}
          </button>
        </div>
      </div>
    </div>
...
const handleEnterEnvSetup = async () => {
  if (!props.projectData?.project_id || !props.projectData?.graph_id) {
    console.error('Informations de projet ou de graphe manquantes')
    return
  }
  ...
  try {
    ...
    alert('Exception lors de la création de la simulation : ' + (backendError || err.message))
  } finally {
